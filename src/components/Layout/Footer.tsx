...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-medical-800 to-medical-900 text-white pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="rounded-full bg-white p-2">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19 8c-1.7 0-3 1.3-3 3v2c0 1.7-1.3 3-3 3h-2c-1.7 0-3-1.3-3-3v-2c0-1.7-1.3-3-3-3H2v10h17c1.7 0 3-1.3 3-3v-4c0-1.7-1.3-3-3-3z" fill="#2563eb"/>
                  <path d="M12 2c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2s2-.9 2-2V4c0-1.1-.9-2-2-2z" fill="#2563eb"/>
                </svg>
              </div>
            ...
            <p className="text-gray-300 leading-relaxed">
              Providing quality healthcare services with a human touch, making healthcare accessible and affordable for all.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 mt-0.5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                </svg>
                <p className="text-gray-300">Regional College Of Management, Chandrasekharpur, Bhubaneswar, Odisha</p>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">debasmitfordev@gmail.com</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
